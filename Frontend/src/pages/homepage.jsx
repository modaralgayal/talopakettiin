...
export const Homepage = () => {
  ...
  const jsonLd = {
    ...
    logo: "https://talopakettiin.fi/talopakettiinlogovariants-black.png",
    description:
      "Kilpailuta talopaketit yhdessä paikassa ja valitse niistä sopivin!",
    address: {
      "@type": "PostalAddress",
      addressCountry: "FI",
    },
    sameAs: [
      "https://www.facebook.com/talopakettiin",
      "https://www.linkedin.com/company/talopakettiin",
    ],
    offers: {
      "@type": "AggregateOffer",
      priceCurrency: "EUR",
  ...
  return (
    <div className="min-h-screen font-['Avenir']">
      <Helmet>
        ...
        <meta
          name="description"
          content="Kilpailuta talopaketit yhdessä paikassa ja valitse niistä sopivin! Löydä unelmiesi talopaketti helposti ja nopeasti."
        />
        <meta
          name="keywords"
          content="talopaketti, 
          talopaketit, 
          omakotitalo, rakentaminen, talonrakentaminen, talonrakennus, talopaketti kilpailutus, talopaketti vertailu,
          paritalo, rivitalo, rakennus, kilpailutus, talo, tontti, talorakennus, tonttirakennus, talopakettiin, Talopaketti hinta, talopaketti hinta, 
          talopaketti hinnoitus, halpa talopaketti, talopaketti myynti, Paras talopaketti, parhaat talopaketit, muuttovalmis talopaketti"
        />
        <meta name="author" content="Talopakettiin" />
        <meta name="robots" content="index, follow" />
        <meta
          property="og:title"
          content={`Talopakettiin - ${t("navigation.home")}`}
        />
        <meta
        ...
        <meta property="og:url" content="https://talopakettiin.fi" />
        <meta
          property="og:image"
          content="https://talopakettiin.fi/og-image.jpg"
        />
        ...
        <meta
          ...
          content="Kilpailuta talopaketit yhdessä paikassa ja valitse niistä sopivin! Löydä unelmiesi talopaketti helposti ja nopeasti."
        />
        <link rel="canonical" href="https://talopakettiin.fi" />
